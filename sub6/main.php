				...
				<div class="loginBox">
					<div class="log_box">
						<form name="login_form" method="post" action="login.php">
							...
							<p class="log">
								<span>
									<input name="id" type="text" class="log_ctrl" value="admin" title="아이디" />
								</span>
							</p>
							<p class="log">
								<span>
									<input name="pass" type="password" class="log_ctrl" value="1234" title="패스워드" autocomplete="off" maxlength="30"/>
								</span>
							</p>
							<p class="log">
								<span>
