...
<head>
  ...
  <meta charset="utf-8">
  <link rel="stylesheet" type="text/css" href="css/sub12.css">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <style>
    font.holy {font-family: tahoma;font-size: 16px;color: #FF6C21;}
    font.blue {font-family: tahoma;font-size: 16px;color: #0000FF;}
    font.black {font-family: tahoma;font-size: 16px;color: #000000;}
    tr>th{width: 26px;}
    tr>td{width: 26px; border:  1px solid #cccccc;}
    tr>td>font{line-height: 30px; padding-left:  3px;}
  </style>
...
<table class="table">
  <tr align="center" >
    <td> <a href=<?php echo 'calendar.php?year='.$prev_year.'&month='.$prev_month . '&day=1'; ?>>◀</a>
    </td>
    ...
    <td><a href=<?php echo 'calendar.php?year='.$next_year.'&month='.$next_month.'&day=1'; ?>>▶</a>
    </td>
  </tr>
  <tr class="info">
    <th hight="30">일</td>
