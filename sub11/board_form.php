	...
	<section>
		...
		<div class="board_box">
			<div class="board_menu_wrap">
				...
				<table class="table">
				  <tr align="center" >
				    <td> <a href=<?php echo 'board_form.php?year='.$prev_year.'&month='.$prev_month . '&day=1'; ?>>◀</a>
				    </td>
				    <td height="30" bgcolor="#FFFFFF" colspan="5">
				        <a href=<?php echo 'board_form.php?year=' . $thisyear . '&month=' . $thismonth . '&day=1'; ?>>
				        <?php echo "&nbsp;&nbsp;" . $year . '년 ' . $month . '월 ' . "&nbsp;&nbsp;"; ?></a>
				    </td>
				    <td><a href=<?php echo 'board_form.php?year='.$next_year.'&month='.$next_month.'&day=1'; ?>>▶</a>
				    </td>
				  </tr>
				  <tr class="info">
				    <th hight="30">일</td>
				...
				<form name="board_form" method="post" action="board_insert.php" enctype="multipart/form-data">
					<ul id="board_form">
						...
						<li>
							...
							<span class="col2"><input name="subject" type="text" class="subject"></span>
						</li>	    	
						<li id="text_area">	
						...
						<li>
							...
							<span class="col2 upload_box"><input type="file" name="upfile" class="upload_btn"></span>
						</li>
					</ul>
					<ul class="buttons">
