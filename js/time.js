	...
	doomsday = new Date('Marc 18, 2022 00:00:00')
	today = new Date()
	...
	if(howfar>0){
		...
		document.getElementById('countment').innerHTML = '제 20대 대통령선거 종료'
	...
	// 남은 일수, 시간, 분, 초가 각 100또는 10보다 작은 경우 10의 자리 혹은 100의 자리를 0으로 표현
